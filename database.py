...
with con:
    ...
    cur.execute('INSERT INTO ftasks (name, due_date, priority, status) VALUES("Finish this tut", "02/03/2013", 10, 1)');
    cur.execute('INSERT INTO ftasks (name, due_date, priority, status) VALUES("Finish this food", "03/03/2013", 10, 1)');
